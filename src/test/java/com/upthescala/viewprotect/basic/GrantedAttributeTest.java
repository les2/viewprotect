...
public class GrantedAttributeTest {
	...
	public Object[][] anyGrantedTestDataProvider() {
		return new Object[][] {
				{ anyGranted("ROLE_A", "ROLE_B"), allowed("ROLE_A"),
						denied("ROLE_C") },
				{ anyGranted("ROLE_X"), allowed("ROLE_X"), denied() },
				{ anyGranted("A", "B", "C"), allowed("Z", "X", "B", "F"),
						denied("X", "y", "a") },
				{ notGranted("a"), allowed("b"), denied("d", "e", "a", "g") },
				{ notGranted("x", "y"), allowed("a", "b", "c"),
						denied("d", "x", "a", "g") },
				{ notGranted("x", "y"), allowed("a", "b", "c"),
						denied("d", "y", "a", "g") },
				{ allGranted("a", "b", "c"), allowed("a", "b", "c"),
						denied("a", "b") },
				{ allGranted("a", "b", "c"), allowed("a", "y", "b", "x", "c"),
						denied("b") }, };
	}
